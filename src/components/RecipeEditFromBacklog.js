...
export default function RecipeEdit() {
  ...
  async function editRecipe(event) {
    ...
    const recipeDocRef = doc(db, 'recipes', recipeFromBacklog.id)
    await updateDoc(recipeDocRef, {
      id: recipeFromBacklog.id,
  ...
  useEffect(() => {
    if (typeof recipeFromBacklog !== "undefined") {
      setIngredients(recipeFromBacklog.ingredients)
      setSteps(recipeFromBacklog.steps)
    }
  }, [recipeFromBacklog])
  ...
  return (
    <>
      ...
      {typeof recipeFromBacklog !== "undefined" && typeof ingredients !== "undefined" && typeof steps !== "undefined" &&
        <>
            ...
            <form data-testid="recipe-form-submit" onSubmit={editRecipe}
              ...
              <div key="input-row-name" className="input-row">
                ...
                <input
                  ...
                  name="name" defaultValue={recipeFromBacklog.name} />
              </div>
              ...
              <div key="input-row-imageURL" className="input-row">
                ...
                <input
                  ...
                  id="imageURL" name="imageURL" defaultValue={recipeFromBacklog.imageURL} />
